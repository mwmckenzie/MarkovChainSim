...
namespace MarkovChainModel {
    public class ProbabilityMapper : MonoBehaviour {
        ...
        [SerializeField] private ConversionProbabilities _conversionProbs;
        
        [Title("Parameter Ratios")][HideLabel, PropertyOrder(-1)]
        [SerializeField] private SeirParamRatios _paramRatios;
        
        [Title("Transmission Rates")][HideLabel, PropertyOrder(-1)]
        [SerializeField] private TransmissionRates _transmissionRates;
        ...
        [TitleGroup("Conversion Connectors/Exposed To Infectious Connector"), HideLabel][InlineEditor]
        [SerializeField] private Connector exposedToInfectiousRate;

        [TitleGroup("Conversion Connectors/Symptomatic To Recovered Connector"), HideLabel][InlineEditor]
        [SerializeField] private Connector symptomaticRecoveryRate;

        [TitleGroup("Conversion Connectors/Asymptomatic To Recovered Connector"), HideLabel][InlineEditor]
        [SerializeField] private Connector asymptomaticRecoveryRate;

        [TitleGroup("Conversion Connectors/Hospitalization To Recovered Connector"), HideLabel][InlineEditor]
        [SerializeField] private Connector hospitalizationRecoveryRate;

        [TitleGroup("Conversion Connectors/Critical To Recovered Connector"), HideLabel][InlineEditor]
        [SerializeField] private Connector criticalRecoveryRate;

        [TitleGroup("Conversion Connectors/Recovered To Susceptible Connector"), HideLabel][InlineEditor]
        [SerializeField] private Connector recoveredToSusceptibleRate;

        [TitleGroup("Conversion Connectors/Vaccinated To Susceptible Rate"), HideLabel][InlineEditor]
        [SerializeField] private Connector vaccinatedToSusceptibleRate;
        
        [FoldoutGroup("Ratio Connectors")]
        [TitleGroup("Ratio Connectors/Hospitalized To Non-Hospitalized Ratio"), HideLabel][InlineEditor]
        [SerializeField] private Connector hospToNonHospRatio;
        
        [TitleGroup("Ratio Connectors/Asymptomatic To Symptomatic Ratio"), HideLabel][InlineEditor]
        [SerializeField] private Connector asympToSympRatio;

        [TitleGroup("Ratio Connectors/Critical To Hospitalized Ratio"), HideLabel][InlineEditor]
        [SerializeField] private Connector criticalToHospRatio;
        
        [TitleGroup("Ratio Connectors/Deceased To Critical Recovered Ratio"), HideLabel][InlineEditor]
        [SerializeField] private Connector deceasedToCriticalRecovRatio;
        
        [FoldoutGroup("Transmission Rates")]
        [TitleGroup("Transmission Rates/Symptomatic Transmission Rate"), HideLabel][InlineEditor]
        [SerializeField] private Connector sympTransmissionRate;
        
        [TitleGroup("Transmission Rates/Asymptomatic Transmission Rate"), HideLabel][InlineEditor]
        [SerializeField] private Connector asympTransmissionRate;

        [TitleGroup("Transmission Rates/Hospitalized Transmission Rate"), HideLabel][InlineEditor]
        [SerializeField] private Connector hospitalTransmissionRate;
        
        [TitleGroup("Transmission Rates/Critical Transmission Rate"), HideLabel][InlineEditor]
        [SerializeField] private Connector criticalTransmissionRate;
        
        [TitleGroup("Transmission Rates/Visitor Transmission Rate"), HideLabel][InlineEditor]
        [SerializeField] private Connector visitorTransmissionRate;
    ...
    public class SeirModelParameters {
        ...
        [LabelWidth(180)] public float exposedToInfectiousRate;
        ...
        [Title("Ratios")]
        [LabelWidth(180)] public float hospToNonHospRatio;
        ...
        [Title("Transmission Rates")]
        [LabelWidth(180)]  public float sympTransmissionRate;
        ...
        [Title("Testing Rates")] 
        [LabelWidth(180)]  public float susceptibleTestingRate;
        ...
        [Title("False Test Result Rates")] 
        [LabelWidth(180)]  public float falsePosRate;
